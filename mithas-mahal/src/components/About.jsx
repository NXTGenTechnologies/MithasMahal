...
import aboutImg from '../assets/images/laddu.jpg';

const About = () => {
  return (
    <section className="text-center py-16 px-4">
      <h1 className="text-3xl text-green-600 mb-4">Quality that delights, In every bite.</h1>
      <p className="mb-4 text-lg">At Mcube, each sweet is a masterpiece crafted with the finest ingredients and a passion for perfection. Experience a blend of tradition, innovation, and unmatched flavor.</p>
