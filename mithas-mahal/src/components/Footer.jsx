  ...
  return (
    <footer className="bg-transparent pt-12 pb-6">
      <div className="container mx-auto px-4 md:px-20 lg:px-32">
            ...
            <address className="not-italic text-gray-800 space-y-2">
              <div className="flex flex-col space-x-4 mt-4 leading-8">
                <div>
                  ...
                  <span>123, Sector 1 main road, Gurugram, Haryana, PIN - 122001, India</span>
                </div>
                <div>
                ...
                <div>
                  ...
                  <span>contact@mithasmahal.com</span>
                </div>
              </div>
            </address>
          </motion.div>
        ...
        >
          <p>Copyright © 2025 Mithas Mahal. All Rights Reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
